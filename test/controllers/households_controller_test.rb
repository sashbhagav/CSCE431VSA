...
class HouseholdsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create household" do
    assert_difference('Household.count') do
      post households_url, params: { household: { UIN: @household.UIN, classification: @household.classification, email: @household.email, family: @household.family, first: @household.first, last: @household.last, major: @household.major, phonenumber: @household.phonenumber } }
    end
  ...
  test "should update household" do
    patch household_url(@household), params: { household: { UIN: @household.UIN, classification: @household.classification, email: @household.email, family: @household.family, first: @household.first, last: @household.last, major: @household.major, phonenumber: @household.phonenumber } }
